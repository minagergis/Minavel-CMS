            ...
            <div class="portlet light bordered">
                ...
                <div class="portlet-body">
                    ...
                    <div class="row media">
                        @if(isset($media))
                            @foreach($media as $m)
                                <div class="col-md-2 col-sm-2 col-xs-3"><a data-toggle="modal" data-number="{{$m->id}}"
                                                                           href="#media-full" class="media-data"><img
                                                class="img-responsive"
                                                src="{{asset('public')}}/uploads/thumbnail/{{$m->guid}}"></a></div>
                            @endforeach
                        @endif
                    </div>
                </div>
