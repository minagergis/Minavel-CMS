                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    ...
                                    <div class="actions">
                                        <div class="btn-group">
                                            <a href="{{ route('admin.city.add.get') }}" class="btn sbold green">
                                                Add New
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            var oTable = $('#table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('admin.city.data.get') }}",
                },
                columns: [

                    {data: 'name', name: 'city_translations.name'},
                    @if(isset($language_available))
                        @foreach($language_available as $l)
                        {
                            data: '{{{ $l }}}', name: 'city.id', orderable: false, searchable: false
                        },
                        @endforeach
                    @endif
