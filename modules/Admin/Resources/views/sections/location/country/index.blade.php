                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    ...
                                    <div class="actions">
                                        <div class="btn-group">
                                            <a href="{{ route('admin.country.add.get') }}" class="btn sbold green">
                                                Add New
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            var oTable = $('#table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('admin.country.data.get') }}",
                },
                columns: [
                    {data: 'name', name: 'country_translations.name'},
                    @if(isset($language_available))
                        @foreach($language_available as $l)
                        {
                            data: '{{{ $l }}}', name: 'country.id', orderable: false, searchable: false
                        },
                        @endforeach
                    @endif
                    {
