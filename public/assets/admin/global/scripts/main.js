jQuery(document).ready(function () {
    ...
    $("#screen-options").change(function() {
      $(".screen-options").slideToggle( "slow" );
    });

	$(".upload-button").click(function() {
	  $(".upload-area").slideToggle( "slow" );
	});

	$( ".screen-options input[type=checkbox]" ).each(function() {
		if ( $(this).is( ":checked" ) ){
			$("."+$(this).attr('id')).show();
		}else{
			$("."+$(this).attr('id')).hide();
	...
	$('.screen-options input[type=checkbox]').change(function() {
		if ( $(this).is( ":checked" ) ){
			$("."+$(this).attr('id')).show();
		}else{
			$("."+$(this).attr('id')).hide();
    ...
    // $(".bfh-countries input[type=hidden]").attr("name","flag");
    function selectAll() {
        $('.menu-content input[type="checkbox"]').each(function() {
            this.checked = true;
        });
        $(this).one("click", selectNone);
    }
    function selectNone() {
        $('.menu-content input[type="checkbox"]').each(function() {
            this.checked = false;
        });
        $(this).one("click", selectAll);
    }
    $(".select-all").one("click", selectAll);
    $(".lang select").change(function(){
        $(".lang i").removeClass().addClass("glyphicon bfh-flag-"+$('option:selected', this).attr("data-flag"));
    });
